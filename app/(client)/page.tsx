...
function SparkleIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden="true">
      ...
      />
      <path d="M15.5 12.5l.7 2 2 .7-2 .7-.7 2-.7-2-2-.7 2-.7.7-2z" stroke="white" strokeWidth="1.2" strokeLinejoin="round" />
    </svg>
  );
}
...
function StarIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 14 14" fill="#f5a623" aria-hidden="true">
...
const TESTIMONIALS = [
  {
    role: "PMP Learner",
    quote: "The structured pathway made it easy to know exactly what to focus on next.",
  },
  {
  ...
  {
    role: "UI/UX Designer",
    quote: "The advisor session helped me pick the right track instead of guessing.",
  },
];
...
const HomePage = () => {
  ...
  return (
    <div>
      {/* Hero */}
      <section className="relative overflow-hidden bg-gradient-to-br from-main to-deep-blue px-6 py-20 text-white">
        <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-10 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-4 max-w-lg text-white/70">
              Structured career pathways designed to take you from beginner to expert. Globally
              recognised certifications, expert instructors, and personalised advisor support.
            </p>
          ...
          <div
            className="hidden aspect-video rounded-2xl lg:block"
            style={{
              background:
      ...
      <section id="pathways" className="mx-auto max-w-6xl px-6 py-20">
        <div className="text-center">
          <p className="text-xs font-semibold uppercase tracking-wide text-secondary">Career Pathways</p>
          <h2 className="mt-2 text-3xl font-semibold text-gray-900">Choose Your Career Path</h2>
          <p className="mx-auto mt-2 max-w-xl text-sm text-gray-500">
            Follow a structured learning pathway designed around your experience level and career
            goals.
          </p>
        </div>
          ...
          {pathways?.map((pathway, i) => {
            ...
            return (
              <div key={pathway.id} className="rounded-2xl bg-secondary/5 p-6">
                ...
                <h3 className="mt-4 text-lg font-semibold text-gray-900">{pathway.title}</h3>
                <p className="mt-2 text-sm text-gray-500">{pathway.description}</p>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        <div className="flex items-end justify-between">
          <div>
            <p className="text-xs font-semibold uppercase tracking-wide text-secondary">Programs</p>
            <h2 className="mt-2 text-3xl font-semibold text-gray-900">Featured Programs</h2>
          </div>
          <Link
            href="/programms"
        ...
        <div className="mt-8 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {programsLoading && <p className="text-sm text-gray-400">Loading programs…</p>}
      ...
      {/* Learning journey */}
      <section className="mx-auto max-w-5xl px-6 py-16 text-center">
        <p className="text-xs font-semibold uppercase tracking-wide text-secondary">Learning Structure</p>
        <h2 className="mt-2 text-3xl font-semibold text-gray-900">Your Learning Journey</h2>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16 text-center">
        <p className="text-xs font-semibold uppercase tracking-wide text-secondary">Learner Stories</p>
        <h2 className="mt-2 text-3xl font-semibold text-gray-900">What Our Learners Say</h2>

        <div className="mt-10 grid grid-cols-1 gap-5 sm:grid-cols-3">
          {TESTIMONIALS.map((t) => (
            <div key={t.role} className="rounded-2xl border border-gray-100 bg-white p-6 text-left">
      ...
      <section className="mx-auto max-w-6xl px-6 pb-6">
        <div className="rounded-3xl bg-main px-8 py-14 text-center text-white">
          <h2 className="text-2xl font-semibold">Not Sure Which Path Is Right For You?</h2>
          <p className="mx-auto mt-2 max-w-xl text-sm text-white/70">
            Speak with a CareerCentra advisor and receive a personalised learning recommendation
      ...
      <section className="mx-auto max-w-6xl px-6 pb-20">
        <div className="rounded-3xl bg-deep-blue px-8 py-14 text-center text-white">
          <p className="text-xs font-semibold uppercase tracking-wide text-glass">Get Started</p>
          <h2 className="mt-2 text-2xl font-semibold">Ready to Build Your Future?</h2>
          <p className="mx-auto mt-2 max-w-xl text-sm text-white/70">
            Choose your career path and start building recognised, practical capabilities.
          </p>
          <div className="mt-6">
            <Link
              href="/registration"
